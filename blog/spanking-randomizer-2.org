...
#+BEGIN_HTML
<style>
#naked:checked ~ #bare, #same:checked ~ #switch, #sameimpl ~ #switchimpl{
  display: none;
}
...
<div id="switchimpl">
  <p>Then here you go! The <b>Base Swats</b> refers to the maximum number
you can get when you don't touch the intensity... And variants are any
number of special types of each implement you may have lying around.</p>
