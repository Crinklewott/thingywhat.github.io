...
<input style="width:100%; margin-left:0px;" type="range" min="0" max="100" value="50" onchange="updateSlider(value)" />
<script>
var updateSlider = function(){
  ...
  return function(intensity){
    document.getElementById("intense").innerHTML = intense.filter(function(x){
      return x[0] < 10;
    }).reduce(function(x, y){
      return x[0] > y[0] ? x : y;
    })[1];
...
<div id="intense" style="text-align: center;">That hurts!</pre>
#+END_HTML

Are you OK with nakedness?
