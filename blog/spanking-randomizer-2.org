#+TITLE:       Spanking Randomizer settings
#+AUTHOR:      thingywhat
...
* Nastiness
Do you want the randomizer to be particularly nasty?
#+BEGIN_HTML
...
#+BEGIN_HTML
<input type="radio" name="naked" id="naked" />Whatever
<input type="radio" name="naked" />NO!
#+END_HTML

* Display?
Display the spanking immediately?
#+BEGIN_HTML
<input type="radio" name="show" id="show" />Sure
<input type="radio" name="show" />Nah
#+END_HTML
