  ...
  window.gamble = (function(){    
    ...
    return function(){
      ...
      var swats = adjustedRandom(minimum, impl.max); 
        ...
        impl.verb + " " + state + " " + swats + " time" +
        (swats > 1 ? "s" : "") + " in the " + pos + " position" +
        (impl.adjectives ? " with a " + pick(impl.adjectives) + " " +
        impl.name : "");
    };
  })();
...
Want to tweak the randomizer? Have some [[http://thingywhat.github.io/blog/2015/01/22/A%20script%20for%20daredevil%20butt-gamblers/][customization options!]]
